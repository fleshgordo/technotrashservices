  ...
  (function(b, c) {
    ...
    b.Widget.prototype = {
      ...
      _trigger: function(e, a, d) {
        ...
        a = b.Event(a);
        a.type = (e === this.widgetEventPrefix
          ? e
    ...
    b.widget("ui.draggable", b.ui.mouse, {
      ...
      _getParentOffset: function() {
        ...
        return {
          ...
          left:
            c.left + (parseInt(this.offsetParent.css("borderLeftWidth"), 10) || 0)
        };
      },
  ...
  (function(b) {
    ...
    b.ui.plugin.add("resizable", "containment", {
      ...
      resize: function(g) {
        ...
        a = Math.abs(
          (e._helper ? e.offset.left - i.left : e.offset.left - i.left) +
            e.sizeDiff.width
        );
        d = Math.abs(
          ...
          if (this.containers.length === 1) {
            ...
            for (
              var a = this.positionAbs[
                  this.containers[g].floating ? "left" : "top"
                ],
    ...
    b.widget("ui.accordion", {
        ...
        if (!g.disabled)
          if (c.target) {
            ...
            if (!(this.running || (!g.collapsible && f))) {
              ...
              var a =
                this.headers.index(this.active[0]) > this.headers.index(c[0]);
              this.active = f ? b([]) : c;
              this._toggle(i, d, h, f, a);
              e.removeClass("ui-state-active ui-corner-top")
      ...
      _toggle: function(c, f, g, e, a) {
        ...
        f.prev()
          ...
          .blur();
        c.prev()
          .attr({ "aria-expanded": "true", tabIndex: 0 })
          .focus();
      },
            ...
            i.element.queue("tabs", function() {
              i._trigger(
                ...
                i._ui(
                  ...
                  i.element.find(
                    i._sanitizeSelector(i.anchors[j.selected].hash)
                  )[0]
                )
              );
            });
