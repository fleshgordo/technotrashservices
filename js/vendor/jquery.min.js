...
(function(a, b) {
      ...
      for (; i < j && (k || !l); i++)
        (l = h[i](c, d, e)),
          typeof l === "string" &&
            (!k || g[l]
              ? (l = b)
              : (c.dataTypes.unshift(l), (l = bP(a, c, d, e, l, g))));
            ...
            : c.attachEvent &&
              (y = function() {
                c.readyState === "complete" &&
                  (c.detachEvent("onreadystatechange", y), d.ready());
              });
        return d;
      })(),
    ...
    d.extend({
      ...
      when: function(a) {
        ...
        if (e > 1) {
          for (; c < e; c++)
            b[c] && d.isFunction(b[c].promise)
              ? b[c].promise().then(i(c), h.reject)
              : --g;
          g || h.resolveWith(h, b);
                ...
                (d.support.reliableHiddenOffsets = e[0].offsetHeight === 0),
                  ...
                  c.defaultView &&
                    ...
                    (d.support.reliableMarginRight =
                      (parseInt(
                        c.defaultView.getComputedStyle(a, null).marginRight,
                        10
                      ) || 0) === 0)),
      ...
      removeData: function(b, c, e) {
        if (d.acceptData(b)) {
          ...
          d.support.deleteExpando || h != a ? delete h[j] : (h[j] = null),
            l
              ? ((h[j] = {}), g || (h[j].toJSON = d.noop), (h[j][f] = l))
              : g &&
        ...
        data: function(a, c) {
          ...
          if (c === b) {
            (e = this.triggerHandler("getData" + k[1] + "!", [k[0]])),
              e === b &&
                this.length &&
                ((e = d.data(this[0], a)), (e = h(this[0], a, e)));
            ...
            if ((c in a || a[c] !== b) && g && !i) {
              ...
              if (c === "tabIndex") {
                ...
                return k && k.specified
                  ? k.value
                  : o.test(a.nodeName) || (p.test(a.nodeName) && a.href)
                  ? 0
                  : b;
              }
              return a[c];
    ...
    (d.event = {
      add: function(c, e, f, g) {
        if (c.nodeType !== 3 && c.nodeType !== 8) {
          ...
          l || (k.events = l = {}),
            m ||
              (k.handle = m = function(a) {
                return typeof d !== "undefined" && d.event.triggered !== a.type
      ...
      special: {
        ...
        live: {
          add: function(a) {
            d.event.add(
              this,
              H(a.origType, a.selector),
              d.extend({}, a, { handler: G, guid: a.handler.guid })
            );
          },
          remove: function(a) {
    ...
    (Z.optgroup = Z.option),
        ...
        html: function(a) {
          if (a === b)
            return this[0] && this[0].nodeType === 1
              ? this[0].innerHTML.replace(R, "")
              : null;
          if (
            typeof a !== "string" ||
            X.test(a) ||
            (!d.support.leadingWhitespace && S.test(a)) ||
            Z[(U.exec(a) || ["", ""])[1].toLowerCase()]
          )
            d.isFunction(a)
      ...
      (d.buildFragment = function(a, b, e) {
        ...
        a.length === 1 &&
          ...
          a[0].charAt(0) === "<" &&
          !X.test(a[0]) &&
          (d.support.checkClone || !Y.test(a[0])) &&
            ...
            if (typeof i !== "string" || W.test(i)) {
              if (typeof i === "string") {
                ...
                !d.support.leadingWhitespace &&
                  S.test(i) &&
                  m.insertBefore(b.createTextNode(S.exec(i)[0]), m.firstChild),
                  (i = m.childNodes);
              }
          ...
          (d.cssHooks.marginRight = {
            get: function(a, b) {
              ...
              d.swap(a, { display: "inline-block" }, function() {
                b
                  ? (c = bm(a, "margin-right", "marginRight"))
          ...
          return this.map(function() {
            ...
            .filter(function() {
              return (
                this.name &&
                !this.disabled &&
                (this.checked || bC.test(this.nodeName) || bw.test(this.type))
              );
            })
            .map(function(a, b) {
              var c = d(this).val();
        ...
        ajax: function(a, c) {
          ...
          h.promise(u),
            ...
            (e.dataTypes = d
              ...
              .split(bD)),
            e.crossDomain == null &&
              ((q = bH.exec(e.url.toLowerCase())),
              (e.crossDomain =
                q &&
                (q[1] != bM[1] ||
                  q[2] != bM[2] ||
                  (q[3] || (q[1] === "http:" ? 80 : 443)) !=
                    (bM[3] || (bM[1] === "http:" ? 80 : 443))))),
            e.data &&
              e.processData &&
    ...
    d.ajaxSetup({
      ...
      d.ajaxPrefilter("json jsonp", function(b, c, e) {
        ...
        if (
          ...
          c.jsonpCallback ||
          c.jsonp != null ||
          (b.jsonp !== !1 && (bU.test(b.url) || (f && bU.test(b.data))))
        ) {
          var g,
        ...
        for (var g = 0, h = this.length; g < h; g++)
          (e = this[g]),
            ...
            f === "" &&
              ...
              d._data(e, "olddisplay", cf(e.nodeName));
        for (g = 0; g < h; g++) {
      ...
      d.fn.extend({
        ...
        offsetParent: function() {
          return this.map(function() {
            ...
            while (
              a &&
              (!ch.test(a.nodeName) && d.css(a, "position") === "static")
            )
              a = a.offsetParent;
            return a;
          });
